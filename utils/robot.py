...
def is_q_valid(d, m, q, ignored_geom_names=None):
    ...
    if d.ncon > 0:
        ...
        for i in range(d.ncon):
            ...
            is_robot_contact = geom1_name in UR_JOINT_NAMES or geom2_name in UR_JOINT_NAMES
            is_ignored_contact = geom1_name in ignored_geom_names or geom2_name in ignored_geom_names
            if is_robot_contact and not is_ignored_contact:
